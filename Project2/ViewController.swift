...
class ViewController: UIViewController {
    ...
    @objc func showScore() {
        let myScore = UIAlertController(title: "Check score", message: "Your score is \(score)", preferredStyle: .alert)
        myScore.addAction(UIAlertAction(title: "OK", style: .default, handler: nil))
        present(myScore, animated: true)
    }
}
